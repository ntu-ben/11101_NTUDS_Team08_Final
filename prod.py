...
combined_small.to_csv('./tmp_result/combined_shifted_small.csv', index=False)
...
combined = pd.read_csv('./tmp_result/combined_shifted_small.csv',
                          dtype = combined_dtype_dict,header=0)
toc=timeit.default_timer()
print('Load Time',toc - tic)
...
if is_sub_run:
    result_xgb_5.to_csv('./tmp_result/result_xgb_5.csv',index=False)
#%%
tic=timeit.default_timer()
xgb_features_1 = []
...
if is_sub_run:
    result_xgb_1.to_csv('./tmp_result/result_xgb_1.csv',index=False)
#%%
tic=timeit.default_timer()
...
#%%
if is_sub_run:
    result_xgb_2.to_csv('./tmp_result/result_xgb_2.csv',index=False)
#%%
tic=timeit.default_timer()
...
print('Sorting Time',toc - tic)
if is_sub_run:
    result_xgb_2b.to_csv('./tmp_result/result_xgb_2b.csv',index=False)
#%%
tic=timeit.default_timer()
...
if is_sub_run:
    result_xgb_2ma1.to_csv('./tmp_result/result_xgb_2ma1.csv',index=False)
#%%
tic=timeit.default_timer()
...
if is_sub_run:
    result_xgb_2ma1_mo.to_csv('./tmp_result/result_xgb_2ma1_mo.csv',index=False)
...
#%%
if is_sub_run:
    result_xgb_4.to_csv('./tmp_result/result_xgb_4.csv',index=False)
...
print('Sorting Time',toc - tic)
if is_sub_run:
    result_xgb_5b.to_csv('./tmp_result/result_xgb_5b.csv',index=False)
#%%
tic=timeit.default_timer()
xgb_features_6 = []
...
print('Sorting Time',toc - tic)
if is_sub_run:
    result_xgb_6.to_csv('./tmp_result/result_xgb_6.csv',index=False)
#%%
tic=timeit.default_timer()
xgb_features_6b = []
...
print('Sorting Time',toc - tic)
if is_sub_run:
    result_xgb_6b.to_csv('./tmp_result/result_xgb_6b.csv',index=False)
#%%
# steve_probs = pd.read_csv('./tmp_result/raw_probs20161221b.csv',header=0)
...
if is_sub_run:
    result_xgb_5b = pd.read_csv('./tmp_result/result_xgb_5b.csv',header=0)
#%%
