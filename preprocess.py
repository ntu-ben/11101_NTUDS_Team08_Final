...
reader = pd.read_csv('./santander-product-recommendation/train_ver2.csv', chunksize=100000, header=0)
train = pd.concat([resize_data(chunk) for chunk in reader])

reader_2 = pd.read_csv('./santander-product-recommendation/test_ver2.csv', chunksize=10000, header=0)
